 ...
 * @version  1.1
 */ 
public class SpringHibernate3DaoSupport extends HibernateDaoSupport implements SpringHibernateDao
{
	private static Logger log = LoggerFactory.getLogger(SpringHibernate3DaoSupport.class);
...
//							/** o instanceof java.util.List **/
	...
	{
//		Object o = getHibernateTemplate().executeFind(
//			new HibernateCallback()
//			{
//				public Object doInHibernate(Session session)
//					throws HibernateException, SQLException
		...
		Integer i =  (Integer)this.getHibernateTemplate().execute(
				new HibernateCallback(){
					public Object doInHibernate(Session session)
						...
						CallableStatement cstat = SessionFactoryUtils.getDataSource(getSessionFactory()).
