 ...
 *
 */
public class GlobalEnvDAOImpl_Oracle extends SpringHibernateDaoSupport implements GlobalEnvDAO {
	private static final Logger log = LoggerFactory
			.getLogger(GlobalEnvDAOImpl_Oracle.class);
