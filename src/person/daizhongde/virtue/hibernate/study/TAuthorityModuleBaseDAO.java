...
import person.daizhongde.virtue.hibernate.BaseHibernateDAO;
 ...
 */
public class TAuthorityModuleBaseDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(TAuthorityModuleBaseDAO.class);
	// property constants
	...
	public TAuthorityModule findById(java.lang.Integer id) {
		...
		try {
			TAuthorityModule instance = (TAuthorityModule) getSession().get(
					"person.daizhongde.virtue.ssh.TAuthorityModule", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public TAuthorityModule merge(TAuthorityModule detachedInstance) {
		...
		try {
			TAuthorityModule result = (TAuthorityModule) getSession().merge(
					detachedInstance);
