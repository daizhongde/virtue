 ...
 * <p>
 * Description:
 * <br/>for Combobox , this class is different form the other four assemble class.
...
//	private AbstractConstant absc;
	...
	/**  
	 * when don's pagegation can use this constructor
	 * @param jsonObject
	 * @param absConstant
	 */
	public SQLAssembleQ_CBB(ConfigDocument_SQL  sqlDoc, String selectSQL, Map condition, Map operator, Map columnTypes,  Map front2col){
		this.sqlDoc = sqlDoc;
	...
	public void queryCBBInitialize(){
...
//		String jdata = "{act:\"querycbb\",	operator : {nmid : 1,cmname : 11,nmlevel : 13,cmtarget : 13}, condition:{nmid:1, cmname:\"模块名称\", nmlevel:[1,2,3], cmtarget:[\"R\",\"B\"]}}";
//		JSONObject jsonObject = JSONObject.fromObject(jdata);
//		AbstractConstant absConstant = new AuthorityModule();
//		SQLAssembleQ_CBB sqlA = new SQLAssembleQ_CBB( jsonObject, absConstant );
